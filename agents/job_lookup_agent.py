...
dotenv_path = '/Users/marygracezabala/Documents/Github/My_FIRST_AI_AGENT/.env'
...
def lookup(name: str) -> str:
    ...
    'Context':'Given the list {name_of_job} I want you to get me the top 10 jobs in Senior Cybersecurity Engineer jobs in Canada. It must be:
    - Full Time Permanent
...
if __name__ == "__main__":
    job_urls = lookup(name="Remote Senior AI Engineer jobs in British Colombia")
    print(job_urls)
